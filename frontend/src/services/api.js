...
// Request interceptor
//This means you don’t have to manually include tokens or language every time you call the API.
...
export const ratingAPI = {
  getData: () => api.get('/ratings/homepage'), // Change this line
...
//   accept: (id, data) => api.post(`/service-requests/${id}/accept`, data),
// };
// export const serviceReqAPI = {
 
//   create: (formData) => api.post('/service-requests', formData),
//   // add getAll, getById later if needed
// };
// services/api.js - UPDATE the serviceReqAPI.create method
export const serviceReqAPI = {
  create: (formData) =>
    api.post('/service-requests', formData, {
      headers: { 
